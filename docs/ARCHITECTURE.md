...
JACKs Pools is composed of four core contracts and one external liquidity pool.
          ...
          ▼               ▼                ▼
   ┌─────────────┐ ┌───────────────┐ ┌───────────────┐
   │ Buyer Vault │ │ LP Vault      │ │ Auto Liquidity│
   │ JACKsVault  │ │ JACKsLPVault  │ │ (LP Burned)   │
   └──────┬──────┘ └───────┬───────┘ └───────────────┘
          │                │
          ▼                ▼
   Buyer Reward      LP Reward
       Round             Round
          │                │
          ▼                ▼
       Claim ETH        Claim ETH
...
- Top 60 LP addresses receive proportional ETH distributions.
